import img1 from "../assets/images/22078_screen_forza_5_0.jpg";
import img2 from "../assets/images/maxresdefault.jpg";
import img3 from "../assets/images/HVOtfJadqbzmGEErnca0Qg.jpg";
import img4 from "../assets/images/XFmfa62UYqWg_Qr3pjGgxA.jpeg";
import img5 from "../assets/images/gk3_nfxcbdL1JenEKb9lhg.png";
import img6 from "../assets/images/orig.webp";
export const GAMES = [
  {
    image: img1,
  ...
  },
  {
    ...
    id: 4,
    description:
      "Grand Theft Auto IV для PC позволяет игрокам исследовать знаменитый мир Лос-Сантоса и округа Блэйн в разрешении до 4k и выше с частотой 60 кадров в секунду.",
  },
  {
    image: img5,
